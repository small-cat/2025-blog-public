      ...
      >
        ...
        <div className='flex items-start gap-4'>
          ...
          <div className='group relative'>
            <div className='h-16 w-16 shrink-0 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center'>
        ...
        <div className='mt-2'>
          <div className='text-sm font-medium text-gray-700 mb-2'>
            Catalogue ({column.catalogue.length} articles)
          </div>
          <div className='text-secondary space-y-1'>
            ...
            {hasMore && (
              <div className='text-xs text-gray-400 mt-1'>
                +{column.catalogue.length - 3} more articles
              </div>
            )}
          </div>
        </div>
        ...
        {/* Action Button */}
        <div className='mt-2'>
          <div className='rounded-lg bg-white/50 px-3 py-1.5 text-sm font-medium transition-colors hover:bg-white/80 text-center'>
            View Catalogue
          </div>
        </div>
      </Link>
