...
import { loadColumn, type BlogConfig } from '@/lib/load-blog'
import { useReadArticles } from '@/hooks/use-read-articles'
import LiquidGrass from '@/components/liquid-grass'
import { Comments } from '@/components/comments'

export default function Page() {
	const params = useParams() as { id?: string | string[]; slug?: string | string[] }
	...
	useEffect(() => {
		...
		async function run() {
			...
			try {
				setLoading(true)
				const blogData = await loadColumn(params.id as string, slug)
